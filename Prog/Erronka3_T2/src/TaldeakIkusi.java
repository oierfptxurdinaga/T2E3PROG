...
/**
 * Ligako taldeen informazioa bistaratzen duen interfaze grafikoa.
 * Talde bakoitzaren armarria, izena, entrenatzailea eta zelaia erakusten ditu.
 * @author [HIIM/T2]
 * @version 1.0
 */
public class TaldeakIkusi extends JFrame implements ActionListener, WindowListener {
     ...
     * Log-a hasieratu eta TaldeakIkusi leihoa ikusgarri egiten du.
    ...
    /**
     * TaldeakIkusi klasearen eraikitzailea.
     * Interfaze grafikoaren osagaiak (irudiak, testu-eremuak, botoiak) 
     * sortu eta kokatzen ditu.
     */
    public TaldeakIkusi() {
    ...
    /**
     * Botoien ekintzak kudeatzen ditu. "Itzuli" sakatzean, sistemak begiratzen du 
     * ea erabiltzailea administratzailea, epailea ala ikuslea den, 
     * eta bere jatorrizko menura bueltatzen du.
