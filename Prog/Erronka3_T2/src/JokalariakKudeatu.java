...
/**
 * Administratzaileari jokalariak kudeatzeko (gehitu, ikusi eta ezabatu) 
 * aukera ematen dion interfaze grafikoa.
 * @author [HIIM/T2]
 * @version 1.0
 */
public class JokalariakKudeatu extends JFrame implements ActionListener, WindowListener, ListSelectionListener {
     ...
     * Log-a hasieratu eta JokalariakKudeatu leihoa ikusgarri egiten du.
    ...
    /**
     * JokalariakKudeatu klasearen eraikitzailea.
     * Interfaze grafikoaren osagai guztiak sortu, kokatu eta hasieratzen ditu.
     * Baita ere entzuleak (listeners) esleitzen ditu.
     */
    ...
    /**
     * Erabiltzaileak interfazean egiten dituen ekintzak (botoiak sakatu, taldea aukeratu) kudeatzen ditu.
    ...
    public void actionPerformed(ActionEvent e) {
         ...
         // Taldea aldatzerakoan taula eguneratu
         if(o == cmbtaldenIzena) {
             Tizena = (String) cmbtaldenIzena.getSelectedItem();
             // Taula husten dugu taldea aldatzean
         ...
         if(o == btnSartu) {
             ...
             dtmTaula.addRow(new Object[] {JokalariId, Jizena, Jdorsal, Jadina}); // Ordena zuzenduta
             
             // Behin datuak sartzerakoan testu-eremuak garbitzen dira. 
         ...
         if(o == btnEzabatu) {
             ...
             if (fila == -1) {
                 ...
                 int JokalariId = Integer.parseInt(txtIDjokalaria.getText());
                 int option = JOptionPane.showConfirmDialog(null, "Ziur zaude jokalari hori ezabatu nahi duzula?", null, JOptionPane.YES_NO_OPTION);
                
                 if(option == JOptionPane.YES_OPTION) {
                     madao.JokalariakEzabatu(JokalariId); 
                     dtmTaula.removeRow(fila);
                     LogDAO.getLogger().info("Administratzailea "+Jizena+" izeneko jokalaria ezabatu du.");
    ...
    /**
     * Taulan errenkada bat hautatzen denean, jokalariaren datuak 
     * testu-eremuetara (TextField) pasatzen ditu.
     * @param e Gertaeraren informazioa biltzen duen ListSelectionEvent objektua.
     */
    @Override
